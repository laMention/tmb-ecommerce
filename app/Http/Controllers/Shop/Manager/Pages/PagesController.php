...
namespace App\Http\Controllers\Shop\Manager\Pages;
...
class PagesController extends Controller
{
    ...
    public function __construct()
    {
     ...
     public function index(Request $request)
     {
         ...
         return view('shop.vendor.pages.pages.index', compact('pages', 'searchKey'));
     }

    # return view of create form
    public function create()
    { 
        return view('shop.vendor.pages.pages.create');
    }
     ...
     public function edit(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.pages.edit', compact('page', 'lang_key'));
    }
