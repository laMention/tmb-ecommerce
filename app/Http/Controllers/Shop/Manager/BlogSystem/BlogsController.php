...
namespace App\Http\Controllers\Shop\Manager\BlogSystem;
...
class BlogsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.blogSystem.blogs.index', compact('blogs', 'searchKey', 'is_published'));
    }
    ...
    public function create()
    {
        ...
        $tags = Tag::all();
        return view('shop.vendor.pages.blogSystem.blogs.create', compact('categories', 'tags'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.blogs.index');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.blogSystem.blogs.edit', compact('blog', 'categories', 'tags', 'lang_key'));
    }
