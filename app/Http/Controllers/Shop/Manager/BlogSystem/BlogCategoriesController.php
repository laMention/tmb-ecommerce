...
class BlogCategoriesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.blogSystem.blogCategories.index', compact('categories', 'searchKey'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.blogSystem.blogCategories.edit', compact('category'));
    }
