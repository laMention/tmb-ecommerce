...
class CurrenciesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.systemSettings.currency', compact('currencies', 'searchKey'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.vendor.pages.systemSettings.currencyEdit', compact('currency'));
    }
