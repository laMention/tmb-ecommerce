...
namespace App\Http\Controllers\Shop\Manager\Reports;
...
class ReportsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.reports.sales', compact('products', 'order', 'searchKey'));
    }
    ...
    public function orders(Request $request)
    {
        ...
        return view('shop.vendor.pages.reports.orders', compact('orders', 'deliveryStatus', 'paymentStatus', 'date_var', 'totalAmount'));
    }
    ...
    public function categoryWise(Request $request)
    {
        ...
        return view('shop.vendor.pages.reports.categorySales', compact('categories', 'order', 'searchKey'));
    }
    ...
    public function amountWise(Request $request)
    {
        ...
        return view('shop.vendor.pages.reports.amountWise', compact('orderItems', 'totalPrice', 'order', 'date_var'));
    }
    ...
    public function deliveryStatus(Request $request)
    {
        ...
        return view('shop.vendor.pages.reports.deliveryStatus', compact('orders', 'totalOrders', 'date_var'));
    }
}
