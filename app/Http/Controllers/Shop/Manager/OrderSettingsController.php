...
class OrderSettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('shop.vendor.pages.systemSettings.orderSettings', compact('slots'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.vendor.pages.systemSettings.orderSettingsTimeslotEdit', compact('slot'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('vendor.orderSettings');
    }
