...
namespace App\Http\Controllers\shop\Manager\Roles;
...
class RolesController extends Controller
{
    ...
    {
        $searchKey = null;
        $roles = Role::oldest()->where('p_id','!=',1);
        ...
        return view('shop.vendor.pages.roles.index', compact('roles', 'searchKey'));
    }
    ...
    public function create()
    {
        ...
        return view('shop.vendor.pages.roles.create', compact('permission_groups'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.roles.edit', compact('role', 'permission_groups'));
    }
