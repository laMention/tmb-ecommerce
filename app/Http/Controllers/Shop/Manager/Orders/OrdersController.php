...
namespace App\Http\Controllers\Shop\Manager\Orders;
...
class OrdersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $orders = Order::where('shop_id',auth()->user()->shop_id)->latest();
        ...
        return view('shop.vendor.pages.orders.index', compact('orders', 'searchKey', 'locations', 'locationId', 'searchCode', 'deliveryStatus', 'paymentStatus', 'posOrder'));
    }
    ...
    {
        $order = Order::find($id);
        return view('shop.vendor.pages.orders.show', compact('order'));
    }
