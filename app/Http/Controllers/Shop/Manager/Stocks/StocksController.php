...
class StocksController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('shop.vendor.pages.stocks.create', compact('products', 'locations'));
    }
    ...
    public function getVariationStocks(Request $request)
    {
        ...
        return [
            'success'   => true,
            'variation_stocks'  => view('shop.vendor.pages.stocks.variation_stocks', compact('product', 'location_id'))->render()
        ];
    }
