...
namespace App\Http\Controllers\Shop\Manager\Stocks;
...
class LocationsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.stocks.locations.index', compact('locations', 'searchKey', 'is_published'));
    }
    ...
    {
        return view('shop.vendor.pages.stocks.locations.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.vendor.pages.stocks.locations.edit', compact('location'));
    }
