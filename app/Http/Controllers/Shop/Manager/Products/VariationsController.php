...
class VariationsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.products.variations.index', compact('variations', 'searchKey', 'is_published'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.products.variations.edit', compact('variation', 'lang_key'));
    }
