...
class UnitsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.products.units.index', compact('units', 'searchKey', 'is_published'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.units.index');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.products.units.edit', compact('unit', 'lang_key'));
    }
