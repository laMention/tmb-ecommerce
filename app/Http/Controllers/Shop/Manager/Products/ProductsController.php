...
namespace App\Http\Controllers\Shop\Manager\Products;
...
class ProductsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $products = Product::where('shop_id',auth()->user()->shop_id)->where('etat',1)->latest();
        ...
        return view('shop.vendor.pages.products.products.index', compact('products', 'brands', 'searchKey', 'brand_id', 'is_published'));
    }
    ...
    public function create()
    {
        ...
        $tags = Tag::all();
        return view('shop.vendor.pages.products.products.create', compact('categories', 'brands', 'units', 'variations', 'taxes', 'tags'));
    }
    ...
    public function getVariationValues(Request $request)
    {
        ...
        return view('shop.vendor.pages.products.products.new_variation_values', compact('variation_values', 'variation_id'));
    }
    ...
    public function getNewVariation(Request $request)
    {
        ...
        if (count($variations) > 0) {
            return array(
                ...
                'view' => view('shop.vendor.pages.products.products.new_variation', compact('variations'))->render(),
            );
        } else {
            return false;
        }
    ...
    public function generateVariationCombinations(Request $request)
    {
        ...
        return view('shop.vendor.pages.products.products.new_variation_combinations', compact('combinations'))->render();
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $taxes = Tax::isActive()->get();
        $tags = Tag::all();
        return view('shop.vendor.pages.products.products.edit', compact('product', 'categories', 'brands', 'units', 'variations', 'taxes', 'lang_key', 'tags'));
    }
