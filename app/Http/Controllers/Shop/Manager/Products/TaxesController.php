...
class TaxesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.products.taxes.index', compact('taxes', 'searchKey', 'is_published'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.taxes.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.vendor.pages.products.taxes.edit', compact('tax'));
    }
