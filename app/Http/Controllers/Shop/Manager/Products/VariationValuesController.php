...
class VariationValuesController extends Controller
{
    ...
    public function index(Request $request, $id)
    {
        ...
        if (!$variation) {
            ...
            return redirect()->route('vendor.variations.index');
        }
        ...
        return view('shop.vendor.pages.products.variationValues.index', compact('variation', 'variationValues', 'searchKey'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.variationValues.index', $request->variation_id);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (!$language) {
            ...
            return redirect()->route('vendor.variationValues.index');
        }
        $variationValue = VariationValue::findOrFail($id);
        return view('shop.vendor.pages.products.variationValues.edit', compact('variationValue', 'lang_key'));
    }
