...
class CategoriesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.products.categories.index', compact('categories', 'searchKey'));
    }
    ...
    public function create()
    {
        ...
        return view('shop.vendor.pages.products.categories.create', compact('categories', 'brands'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $brands = Brand::isActive()->get();
        return view('shop.vendor.pages.products.categories.edit', compact('category', 'categories', 'brands', 'lang_key'));
    }
