...
class BrandsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.products.brands.index', compact('brands', 'searchKey', 'is_published'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.products.brands.edit', compact('brand', 'lang_key'));
    }
