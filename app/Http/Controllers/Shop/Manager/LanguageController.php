...
class LanguageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.systemSettings.language', compact('languages', 'searchKey'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.vendor.pages.systemSettings.languageEdit', compact('language'));
    }
    ...
    public function showLocalizations(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.systemSettings.languageLocalizations', compact('language', 'localizations', 'searchKey'));
    }
