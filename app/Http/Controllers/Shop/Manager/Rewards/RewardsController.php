...
namespace App\Http\Controllers\shop.vendor\Rewards;
...
class RewardsController extends Controller
{
    ...
    {
        return view('shop.vendor.pages.rewards.configurations');
    }
    ...
    public function setPoints(Request $request)
    {
        ...
        return view('shop.vendor.pages.rewards.setPoints', compact('products', 'searchKey'));
    }
