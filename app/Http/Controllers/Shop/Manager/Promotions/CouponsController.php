...
class CouponsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.coupons.index', compact('coupons', 'searchKey'));
    }
    ...
    public function create()
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->get();
        return view('shop.vendor.pages.coupons.create', compact('categories', 'products'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.coupons.edit', compact('coupon', 'products', 'categories'));
    }
