...
namespace App\Http\Controllers\Shop\Manager\Promotions;
...
class CampaignsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.campaigns.index', compact('campaigns', 'searchKey'));
    }
    ...
    public function create()
    {
        ...
        return view('shop.vendor.pages.campaigns.create', compact('products'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.campaigns.edit', compact('campaign', 'products'));
    }
    ...
    public function productDiscount(Request $request)
    {
        ...
        return view('shop.vendor.pages.campaigns.campaign_discount', compact('product_ids'));
    }
    ...
    public function productDiscountEdit(Request $request)
    {
        ...
        return view('shop.vendor.pages.campaigns.campaign_discount_edit', compact('product_ids', 'campaign_id'));
    }
