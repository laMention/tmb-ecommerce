...
class LogisticsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.fulfillments.logistics.index', compact('logistics', 'searchKey'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.logistics.index');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.fulfillments.logistics.edit', compact('logistic'));
    }
