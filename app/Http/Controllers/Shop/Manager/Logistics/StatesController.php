...
class StatesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.fulfillments.states.index', compact('states', 'searchKey', 'searchCountry'));
    }
    ...
    public function create()
    {
        ...
        return view('shop.vendor.pages.fulfillments.states.create', compact('countries'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.states.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.vendor.pages.fulfillments.states.edit', compact('countries', 'state'));
    }
