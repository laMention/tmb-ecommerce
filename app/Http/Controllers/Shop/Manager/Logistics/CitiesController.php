...
class CitiesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.fulfillments.cities.index', compact('cities', 'searchKey', 'searchState'));
    }
    ...
    public function create()
    {
        ...
        return view('shop.vendor.pages.fulfillments.cities.create', compact('states'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.cities.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.vendor.pages.fulfillments.cities.edit', compact('states', 'city'));
    }
