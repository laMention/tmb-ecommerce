...
namespace App\Http\Controllers\Shop\Manager\Logistics;
...
class LogisticZonesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.fulfillments.logisticZones.index', compact('logisticZones', 'searchKey', 'searchLogistic'));
    }
    ...
    public function create()
    {
        ...
        return view('shop.vendor.pages.fulfillments.logisticZones.create', compact('logistics'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.logisticZones.index');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('shop.vendor.pages.fulfillments.logisticZones.edit', compact('logisticZone', 'cities'));
    }
