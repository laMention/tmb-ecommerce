...
namespace App\Http\Controllers\Shop\Manager\Pos;
...
class PosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.vendor.pages.pos.index', compact('locations', 'categories', 'brands', 'searchKey'));
    }
    ...
    public function products(Request $request)
    {
        ...
        return [
            'status' => true,
            'products' => view('shop.vendor.pages.pos.inc.products', compact('products'))->render(),
    ...
    public function customers(Request $request)
    {
        ...
        return [
            'status' => true,
            'customers' => view('shop.vendor.pages.pos.inc.customers', compact('customers'))->render(),
        ];
    }
    ...
    public function addToList(Request $request)
    {
        ...
        if (is_null($productVariationStock)) {
            ...
            $responseData = [
                ...
                'carts'     => view('shop.vendor.pages.pos.inc.pos-cart', compact('carts'))->render(),
                'posSummary'     => view('shop.vendor.pages.pos.inc.posSummary', compact('carts'))->render(),
            ];
            return $responseData;
        } else {
    ...
    public function productInfo(Request $request)
    {
        ...
        return view('shop.vendor.pages.pos.inc.variationInfo', ['product' => $product]);
    }
    ...
    public function updatePosSummary(Request $request)
    {
        ...
        return [
            'status'    => true,
            'posSummary'     => view('shop.vendor.pages.pos.inc.posSummary', compact('carts', 'shippingAmount', 'discountAmount', 'discountTypeOption'))->render(),
        ];
    }
    ...
    public function downloadInvoice($id)
    {
        ...
        return PDF::loadView('shop.vendor.pages.orders.invoice', [
            'order' => $order,
