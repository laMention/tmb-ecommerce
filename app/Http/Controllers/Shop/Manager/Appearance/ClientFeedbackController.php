...
class ClientFeedbackController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('shop.vendor.pages.appearance.homepage.clientFeedback', compact('feedback'));
    }
    ...
    {
        $feedback = $this->getFeedback();
        return view('shop.vendor.pages.appearance.homepage.clientFeedbackEdit', compact('feedback', 'id'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('vendor.appearance.homepage.clientFeedback');
    }
