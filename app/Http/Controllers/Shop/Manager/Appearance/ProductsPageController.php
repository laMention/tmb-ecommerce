...
class ProductsPageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('shop.vendor.pages.appearance.products.index', compact('categories'));
    }
    ...
    public function details()
    {
        ...
        return view('shop.vendor.pages.appearance.products.details', compact('widgets'));
    }
    ...
    {
        $widgets = $this->getWidgets();
        return view('shop.vendor.pages.appearance.products.detailsEdit', compact('widgets', 'id'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('vendor.appearance.products.details');
    }
