...
class HeroController extends Controller
{
    ...
    public function hero()
    {
        ...
        return view('shop.vendor.pages.appearance.homepage.hero', compact('sliders'));
    }
    ...
    {
        $sliders = $this->getSliders();
        return view('shop.vendor.pages.appearance.homepage.heroEdit', compact('sliders', 'id'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('vendor.appearance.homepage.hero');
    }
