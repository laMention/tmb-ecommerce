...
class AboutUsPageController extends Controller
{
    ...
    {
        return view('shop.vendor.pages.appearance.aboutUs.intro');
    }
    ...
    public function popularBrands()
    {
        ...
        return view('shop.vendor.pages.appearance.aboutUs.popularBrands', compact('brands'));
    }
    ...
    public function features()
    {
        ...
        return view('shop.vendor.pages.appearance.aboutUs.features', compact('features'));
    }
    ...
    {
        $features = $this->getFeatures();
        return view('shop.vendor.pages.appearance.aboutUs.featureEdit', compact('features', 'id'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('vendor.appearance.about-us.features');
    }
    ...
    public function whyChooseUs()
    {
        ...
        return view('shop.vendor.pages.appearance.aboutUs.whyChooseUs', compact('why_choose_us'));
    }
    ...
    {
        $why_choose_us = $this->getWhyChooseUs();
        return view('shop.vendor.pages.appearance.aboutUs.whyChooseUsEdit', compact('why_choose_us', 'id'));
    }
    ...
    public function updateWhyChooseUs(Request $request)
    {
        ...
        return redirect()->route('vendor.appearance.about-us.whyChooseUs');
    }
