...
class BannerSectionOneController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('shop.vendor.pages.appearance.homepage.bannerSectionOne', compact('banners'));
    }
    ...
    {
        $banners = $this->getBanners();
        return view('shop.vendor.pages.appearance.homepage.bannerSectionOneEdit', compact('banners', 'id'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('vendor.appearance.homepage.bannerOne');
    }
