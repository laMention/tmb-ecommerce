...
namespace App\Http\Controllers\Shop\Manager\Refunds;
...
class RefundsController extends Controller
{
    ...
    {
        return view('shop.vendor.pages.refunds.configurations');
    }
    ...
    public function requests()
    {
        ...
        return view('shop.vendor.pages.refunds.requests', compact('refundRequests'));
    }
    ...
    public function reject(Request $request, $id)
    {
        ...
        return redirect()->route('vendor.refund.requests');
    }
    ...
    public function refunded()
    {
        ...
        $refundRequests = $refundRequests->paginate(paginationNumber());
        return view('shop.vendor.pages.refunds.refunded', compact('refundRequests'));
    }
    ...
    public function rejected()
    {
        ...
        $refundRequests = $refundRequests->paginate(paginationNumber());
        return view('shop.vendor.pages.refunds.rejected', compact('refundRequests'));
    }
}
