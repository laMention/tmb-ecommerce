...
Route::group(
    ...
    function () {
        ...
        Route::group(['prefix' => 'shops'], function(){
            Route::get('/', [ShopManagementController::class, 'index'])->name('admin.shops.index');
            Route::get('/create', [ShopManagementController::class, 'create'])->name('admin.shops.create');
            Route::post('/create', [ShopManagementController::class, 'store'])->name('admin.shops.store');
            Route::get('/edit/{id}', [ShopManagementController::class, 'edit'])->name('admin.shops.edit');
            Route::post('/update', [ShopManagementController::class, 'update'])->name('admin.shops.update');
            Route::get('/delete/{id}', [ShopManagementController::class, 'destroy'])->name('admin.shops.delete');
            Route::post('/update-approved-shop', [ShopManagementController::class, 'updateShopStatus'])->name('admin.shops.updateShopStatus');
            Route::post('/update-published-shop', [ShopManagementController::class, 'updateShopPublishStatus'])->name('admin.shops.updateShopPublishStatus');
            Route::get('/shops-staffs', [ShopManagementController::class, 'shopsEmployees'])->name('admin.shops.shopsEmployees');
