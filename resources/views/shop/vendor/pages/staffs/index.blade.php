                ...
                <div class="col-12">
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                                @can('add_shop_staff') 
                                    <a href="{{ route('vendor.staffs.create') }}" class="btn btn-primary"><i
                            ...
                            <tbody>
                                @foreach ($staffs as $key => $staff)
                                    <tr>
                                        ...
                                        <td>
                                             @php
                                                    $role = \Spatie\Permission\Models\Role::where('id',$staff->role_id)->first(); 
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    @can('edit_shop_staff')
                                                        <a class="dropdown-item"
                                                            href="{{ route('vendor.staffs.edit', ['id' => $staff->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                            <i data-feather="edit-3" class="me-2"></i>{{ localize('Edit') }}
                                                        </a>
                                                    @endcan
                                                    @can('delete_shop_staff')
                                                        <a href="#" class="dropdown-item confirm-delete"
                                                            data-href="{{ route('vendor.staffs.delete', $staff->id) }}"
...
@section('scripts')
    <script>
        ...
        function updateBanStatus(el) {
            ...
            $.post('{{ route('vendor.customers.updateBanStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    status: status
                },
