    ...
    @can('dashboard')
        <section class="tt-section pt-4">
            <div class="container">
                        ...
                        <div class="card tt-page-header">
                            <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                                <div class="tt-page-title">
                                    <h2 class="h5 mb-lg-0">{{ localize('Shop Dashboard') }}</h2>
                                </div>
                                <div class="tt-action">

                                    @can('manage_orders')
                                        <a href="{{ route('vendor.orders.index') }}" class="btn btn-secondary"><i
                                                data-feather="shopping-cart" class="me-2"></i>{{ localize('Manage Sales') }}</a>
                                    @endcan

                                    @can('add_products')
                                        <a href="{{ route('vendor.products.create') }}" class="btn btn-primary ms-2"><i
                                            ...
                                            <div class="dropdown tt-tb-dropdown fs-sm">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    <a class="dropdown-item"
                                                        href="{{ route('vendor.dashboard') }}">{{ localize('Last 7 days') }}</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('vendor.dashboard') }}?&timeline=30">{{ localize('Last 30 days') }}</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('vendor.dashboard') }}?&timeline=90">{{ localize('Last 3 months') }}</a>
                                                </div>
                                            </div>
                                        </div>
                ...
                @can('manage_orders')
                    <div class="row g-3 mb-3">
                        <a href="{{ route('vendor.orders.index') }}" class="col-lg-3 col-sm-6">
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::where('shop_id',auth()->user()->shop_id)->count() }}</h4>
                        ...
                        <a href="{{ route('vendor.orders.index') }}?delivery_status={{ orderPendingStatus() }}"
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isPlacedOrPending()->where('shop_id',auth()->user()->shop_id)->count() }}</h4>
                        ...
                        <a href="{{ route('vendor.orders.index') }}?delivery_status={{ orderProcessingStatus() }}"
                            class="col-lg-3 col-sm-6">
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isProcessing()->where('shop_id',auth()->user()->shop_id)->count() }}</h4>
                        ...
                        <a href="{{ route('vendor.orders.index') }}?delivery_status={{ orderDeliveredStatus() }}"
                            class="col-lg-3 col-sm-6">
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isDelivered()->where('shop_id',auth()->user()->shop_id)->count() }}</h4>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="card">
                                ...
                                @php
                                    $orders = App\Models\Order::where('shop_id',auth()->user()->shop_id)->latest()
                                        ->take(10)
                                        ->get();
                                @endphp
                ...
                <div class="row g-3 mb-3">
                    @can('manage_orders')
                        <a href="{{ route('vendor.orders.index') }}?delivery_status={{ orderPickedUpStatus() }}"
                            class="col-lg-3 col-sm-6">
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isPickedUp()->where('shop_id',auth()->user()->shop_id)->count() }}</h4>
                        ...
                        <a href="{{ route('vendor.orders.index') }}?delivery_status={{ orderCancelledStatus() }}"
                            class="col-lg-3 col-sm-6">
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isCancelled()->where('shop_id',auth()->user()->shop_id)->count() }}</h4>
                        ...
                        <a href="{{ route('vendor.orders.index') }}?delivery_status={{ orderOutForDeliveryStatus() }}"
                            class="col-lg-3 col-sm-6">
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isOutForDelivery()->where('shop_id',auth()->user()->shop_id)->count() }}</h4>
                        ...
                        <a href="{{ route('vendor.orders.index') }}?payment_status={{ paidPaymentStatus() }}"
                            class="col-lg-3 col-sm-6">
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isPaid()->where('shop_id',auth()->user()->shop_id)->count() }}</h4>
                        ...
                        <a href="{{ route('vendor.orders.index') }}?payment_status={{ unpaidPaymentStatus() }}"
                            class="col-lg-3 col-sm-6">
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isUnpaid()->where('shop_id',auth()->user()->shop_id)->count() }}</h4>
                        ...
                        <div class="card h-100 flex-column">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <h4 class="mb-1">{{ \App\Models\Product::where('shop_id',auth()->user()->shop_id)->sum('total_sale_count') }}</h4>
                    ...
                    {{-- <a href="{{ route('vendor.customers.index') }}" class="col-lg-3 col-sm-6">
                        <div class="card h-100 flex-column">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-lg">
                    ...
                    {{-- <a href="{{ route('vendor.subscribers.index') }}" class="col-lg-3 col-sm-6">
                        <div class="card h-100 flex-column">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-lg">
                    ...
                    {{-- <a href="{{ route('vendor.categories.index') }}" class="col-lg-3 col-sm-6">
                        <div class="card h-100 flex-column">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-lg">
                   ...
                   {{-- <a href="{{ route('vendor.brands.index') }}" class="col-lg-3 col-sm-6 d-none">
                        <div class="card h-100 flex-column">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-lg">
