                ...
                <div class="col-12">
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                                @can('add_blogs')
                                    <a href="{{ route('vendor.blogs.create') }}" class="btn btn-primary"><i
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    @can('edit_blogs')
                                                        <a class="dropdown-item"
                                                            href="{{ route('vendor.blogs.edit', ['id' => $blog->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                    ...
                                                    @can('delete_blogs')
                                                        <a href="#" class="dropdown-item confirm-delete"
                                                            data-href="{{ route('vendor.blogs.delete', $blog->id) }}"
...
@section('scripts')
    <script>
        ...
        function updatePopular(el) {
            ...
            $.post('{{ route('vendor.blogs.updatePopular') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('vendor.blogs.updateStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    is_active: is_active
                },
