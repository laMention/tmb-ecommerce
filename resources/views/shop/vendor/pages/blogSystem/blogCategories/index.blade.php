                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    <div class="row">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            ...
                                                            @can('edit_blog_categories')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.blogCategories.edit', ['id' => $category->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                            ...
                                                            @can('delete_blog_categories')
                                                                <a href="#" class="dropdown-item confirm-delete"
                                                                    data-href="{{ route('vendor.blogCategories.delete', $category->id) }}"
                        ...
                        @can('add_blog_categories')
                            <form action="{{ route('vendor.blogCategories.store') }}" class="pb-650" method="POST">
                                @csrf
                                <!-- Category info start-->
