                        ...
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                                @can('add_roles_and_permissions')
                                    <a href="{{ route('vendor.roles.create') }}" class="btn btn-primary"><i
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            ...
                                                            {{-- @can('edit_roles_and_permissions') --}}
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.roles.edit', ['id' => $role->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                            ...
                                                            @can('delete_roles_and_permissions')
                                                                <a href="#" class="dropdown-item confirm-delete"
                                                                    data-href="{{ route('vendor.roles.delete', $role->id) }}"
