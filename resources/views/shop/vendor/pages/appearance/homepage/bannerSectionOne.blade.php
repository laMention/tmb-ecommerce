        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                                                    ...
                                                    <div class="dropdown tt-tb-dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('vendor.appearance.homepage.editBannerOne', ['id' => $banner->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                                <i data-feather="edit-3"
                                                                    class="me-2"></i>{{ localize('Edit') }}
                                                            </a>

                                                            <a href="#" class="dropdown-item confirm-delete"
                                                                data-href="{{ route('vendor.appearance.homepage.deleteBannerOne', $banner->id) }}"
                    ...
                    <form action="{{ route('vendor.appearance.homepage.storeBannerOne') }}" method="POST"
