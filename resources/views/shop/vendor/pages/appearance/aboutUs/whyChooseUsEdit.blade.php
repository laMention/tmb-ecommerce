        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    ...
                    <form action="{{ route('vendor.appearance.about-us.updateWhyChooseUs') }}" method="POST"
                        enctype="multipart/form-data" id="section-1">
                        @csrf
                        <input type="hidden" name="id" value="{{ $id }}">
                        @php
                            $each_why_choose_us = null;
                            if (!empty($why_choose_us)) {
                                foreach ($why_choose_us as $key => $thisWhyChooseUs) {
                                    if ($thisWhyChooseUs->id == $id) {
                                        $each_why_choose_us = $thisWhyChooseUs;
                                    }
                                }
                            }
                        @endphp
                                        ...
                                        <div class="tt-product-thumb show-selected-files mt-3">
                                            <div class="avatar avatar-xl cursor-pointer choose-media"
                                                ...
                                                <input type="hidden" name="image"
                                                    value="{{ $each_why_choose_us->image }}">
