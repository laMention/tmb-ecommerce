                ...
                <div class="col-12">
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                                @can('add_campaigns')
                                    <a href="{{ route('vendor.campaigns.create') }}" class="btn btn-primary"><i
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    @can('edit_campaigns')
                                                        <a class="dropdown-item"
                                                            href="{{ route('vendor.campaigns.edit', ['id' => $campaign->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                    ...
                                                    @can('delete_campaigns')
                                                        <a href="#" class="dropdown-item confirm-delete"
                                                            data-href="{{ route('vendor.campaigns.delete', $campaign->id) }}"
...
@section('scripts')
    <script>
        function updatePublishedStatus(el) {
            ...
            $.post('{{ route('vendor.campaigns.updatePublishedStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    status: status
                },
