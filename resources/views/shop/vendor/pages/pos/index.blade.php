                        ...
                        <form action="" class="d-flex flex-column h-100 pos-cart-list-form">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    ...
                                    <a href="{{ route('vendor.pos.index') }}" target="_blank"
...
@section('scripts')
    <script>
        ...
        function getPosProducts() {
            let url = '{{ route('vendor.pos.products') }}';
            $('.pos-products').empty();
        ...
        function showCustomerModal() {
            ...
            $.post('{{ route('vendor.pos.customers') }}', {
                _token: '{{ csrf_token() }}'
            }, function(data) {
                setTimeout(() => {
        ...
        function handleExistingCustomerSelection() {
            ...
            $.post('{{ route('vendor.pos.customerInfo') }}', {
                _token: '{{ csrf_token() }}',
        ...
        function handleNewCustomerSelection() {
            ...
            let url = '{{ route('vendor.pos.newCustomer') }}';
        ...
        function showVariantModal(product_id) {
            ...
            $.post('{{ route('vendor.pos.productInfo') }}', {
                _token: '{{ csrf_token() }}',
                id: product_id
            }, function(data) {
                setTimeout(() => {
        ...
        function addToPosCart(product_variation_id) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: '{{ route('vendor.pos.addToList') }}',
                data: listData,
                success: function(data) {
                    $('.pos-cart-list').empty();
                    $('.pos-summary').empty();
        ...
        function deleteFromCart(product_variation_id) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: '{{ route('vendor.pos.deleteFromCart') }}',
                data: listData,
                success: function(data) {
                    $('.pos-cart-list').empty();
                    $('.pos-summary').empty();
        ...
        function handleQty(product_variation_id, action) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: '{{ route('vendor.pos.handleQty') }}',
                data: listData,
                success: function(data) {
                    $('.pos-cart-list').empty();
                    $('.pos-summary').empty();
        ...
        function addToListByCode() {
            ...
            $.post('{{ route('vendor.pos.getVariationId') }}', {
                _token: '{{ csrf_token() }}',
                code: code
            }, function(data) {
        ...
        function calculatePosSummary() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: '{{ route('vendor.pos.updatePosSummary') }}',
                data: listData,
                success: function(data) {
                    $('.pos-summary').empty();
                    $('.pos-summary').append(data.posSummary);
        ...
        function submitOrder() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: '{{ route('vendor.pos.completeOrder') }}',
                data: listData,
                success: function(data) {
                    $('.pos-cart-list').empty();
                    $('.pos-summary').empty();
                    ...
                    let url = '{{ route('home') }}' + '/vendor/pos/invoice-download/' + data
                    window.open(
                        url,
