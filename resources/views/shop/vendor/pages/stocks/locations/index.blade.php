                ...
                <div class="col-12">
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                                @can('add_locations')
                                    <a href="{{ route('vendor.locations.create') }}" class="btn btn-primary"><i
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    @can('edit_locations')
                                                        <a class="dropdown-item"
                                                            href="{{ route('vendor.locations.edit', ['id' => $location->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
...
@section('scripts')
    <script>
        ...
        function updateDefaultStatus(el) {
            ...
            $.post('{{ route('vendor.locations.updateDefaultStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    status: status
                },
        ...
        function updatePublishedStatus(el) {
            ...
            $.post('{{ route('vendor.locations.updatePublishedStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    status: status
                },
