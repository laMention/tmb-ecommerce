                ...
                <div class="col-12">
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                                @can('add_pages')
                                    <a href="{{ route('vendor.pages.create') }}" class="btn btn-primary"><i
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    @can('edit_pages')
                                                        <a class="dropdown-item"
                                                            href="{{ route('vendor.pages.edit', ['id' => $page->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                    ...
                                                    @can('delete_pages')
                                                        <a href="#" class="dropdown-item confirm-delete"
                                                            data-href="{{ route('vendor.pages.delete', $page->id) }}"
