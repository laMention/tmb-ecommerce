                        ...
                        <div class="card-body">
                            <div class="row justify-content-between align-items-center g-3">
                                ...
                                @can('add_shipping_zones')
                                    <div class="col-auto">
                                        <a href="{{ route('vendor.logisticZones.create') }}" class="btn btn-primary"><i
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    @can('edit_shipping_zones')
                                                        <a class="dropdown-item"
                                                            href="{{ route('vendor.logisticZones.edit', ['id' => $logisticZone->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                    ...
                                                    @can('delete_shipping_zones')
                                                        <a href="#" class="dropdown-item confirm-delete"
                                                            data-href="{{ route('vendor.logisticZones.delete', $logisticZone->id) }}"
