            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    <div class="row">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            @can('edit_logistics')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.logistics.edit', ['id' => $logistic->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                            ...
                                                            @can('delete_logistics')
                                                                <a href="#" class="dropdown-item confirm-delete"
                                                                    data-href="{{ route('vendor.logistics.delete', $logistic->id) }}"
                        ...
                        @can('add_logistics')
                            <form action="{{ route('vendor.logistics.store') }}" class="pb-650" method="POST">
                                @csrf
                                <!-- Logistic info start-->
...
@section('scripts')
    <script>
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('vendor.logistics.updateStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
