                            ...
                            <div class="row justify-content-between align-items-center g-3">
                                ...
                                <div class="col-auto">
                                    @can('add_shipping_states')
                                        <a href="{{ route('vendor.states.create') }}" class="btn btn-primary"><i
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    @can('edit_shipping_states')
                                                        <a class="dropdown-item"
                                                            href="{{ route('vendor.states.edit', ['id' => $state->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
...
@section('scripts')
    <script>
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('vendor.states.updateStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    is_active: is_active
                },
