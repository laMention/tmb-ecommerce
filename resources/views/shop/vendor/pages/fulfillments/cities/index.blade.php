                            ...
                            <div class="row justify-content-between align-items-center g-3">
                                ...
                                <div class="col-auto">
                                    @can('add_shipping_cities')
                                        <a href="{{ route('vendor.cities.create') }}" class="btn btn-primary"><i
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    @can('edit_shipping_cities')
                                                        <a class="dropdown-item"
                                                            href="{{ route('vendor.cities.edit', ['id' => $city->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
...
@section('scripts')
    <script>
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('vendor.cities.updateStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    is_active: is_active
                },
