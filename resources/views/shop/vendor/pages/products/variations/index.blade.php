        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            @can('edit_variations')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.variations.edit', ['id' => $variation->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                            ...
                                                            @can('variation_values')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.variationValues.index', ['id' => $variation->id]) }}">
                                                                    <i data-feather="plus"
                    ...
                    @can('add_variations')
                        <form action="{{ route('vendor.variations.store') }}" class="pb-650" method="POST">
                            @csrf
...
@section('scripts')
    <script>
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('vendor.variations.updateStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    is_active: is_active
                },
