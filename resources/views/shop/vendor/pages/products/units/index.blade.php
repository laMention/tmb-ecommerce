        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            @can('edit_units')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.units.edit', ['id' => $unit->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                            ...
                                                            @can('delete_units')
                                                                <a href="#" class="dropdown-item confirm-delete"
                                                                    data-href="{{ route('vendor.units.delete', $unit->id) }}"
                    ...
                    @can('add_units')
                        <form action="{{ route('vendor.units.store') }}" method="POST" enctype="multipart/form-data"
                            class="pb-650">
                            @csrf
                            <!--brand info start-->
...
@section('scripts')
    <script>
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('vendor.units.updateStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    is_active: is_active
                },
