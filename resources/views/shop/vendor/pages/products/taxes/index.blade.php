        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            @can('edit_taxes')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.taxes.edit', ['id' => $tax->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                            ...
                                                            @can('delete_taxes')
                                                                <a href="#" class="dropdown-item confirm-delete"
                                                                    data-href="{{ route('vendor.taxes.delete', $tax->id) }}"
                    ...
                    @can('add_taxes')
                        <form action="{{ route('vendor.taxes.store') }}" method="POST" enctype="multipart/form-data"
                            class="pb-650">
                            @csrf
                            <!--tax info start-->
...
@section('scripts')
    <script>
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('vendor.taxes.updateStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    is_active: is_active
                },
