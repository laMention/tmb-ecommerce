        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            ...
                                                            @can('edit_brands')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.brands.edit', ['id' => $brand->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                            ...
                                                            @can('delete_brands')
                                                                <a href="#" class="dropdown-item confirm-delete"
                                                                    data-href="{{ route('vendor.brands.delete', $brand->id) }}"
                    ...
                    @can('add_brands')
                        <form action="{{ route('vendor.brands.store') }}" method="POST" enctype="multipart/form-data"
                            class="pb-650">
                            @csrf
                            <!--brand info start-->
