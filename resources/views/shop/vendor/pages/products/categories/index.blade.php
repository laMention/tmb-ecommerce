                ...
                <div class="col-12">
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                                @can('add_categories')
                                    <a href="{{ route('vendor.categories.create') }}" class="btn btn-primary"><i
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    @can('edit_categories')
                                                        <a class="dropdown-item"
                                                            href="{{ route('vendor.categories.edit', ['id' => $category->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                    ...
                                                    @can('delete_categories')
                                                        <a href="#" class="dropdown-item confirm-delete"
                                                            data-href="{{ route('vendor.categories.delete', $category->id) }}"
...
@section('scripts')
    <script>
        ...
        function updateFeatureStatus(el) {
            ...
            $.post('{{ route('vendor.categories.updateFeatureStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    status: status
                },
        ...
        function updateTopStatus(el) {
            ...
            $.post('{{ route('vendor.categories.updateTopStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    status: status
                },
