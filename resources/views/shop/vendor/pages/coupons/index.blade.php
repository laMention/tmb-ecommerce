                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Coupons') }}</h2>
                            </div>
                            <div class="tt-action">
                                @can('add_coupons')
                                    <a href="{{ route('vendor.coupons.create') }}" class="btn btn-primary"><i
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    @can('edit_coupons')
                                                        <a class="dropdown-item"
                                                            href="{{ route('vendor.coupons.edit', ['id' => $coupon->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                    ...
                                                    @can('delete_coupons')
                                                        <a href="#" class="dropdown-item confirm-delete"
                                                            data-href="{{ route('vendor.coupons.delete', $coupon->id) }}"
