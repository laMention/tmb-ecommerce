            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    <div class="row">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            ...
                                                            @can('edit_currency')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.currencies.edit', $currency->id) }}">
                        ...
                        @can('add_currency')
                            <form action="{{ route('vendor.currencies.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!--currency info start-->
                        ...
                        <form action="{{ route('vendor.settings.update') }}" method="POST" class="pb-650 mt-3">
                            @csrf
...
@section('scripts')
    <script>
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('vendor.currencies.updateStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    is_active: is_active
                },
