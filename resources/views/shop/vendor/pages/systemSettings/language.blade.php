            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    <div class="row">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            ...
                                                            @can('edit_languages')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.languages.edit', $language->id) }}">
                                                            ...
                                                            @can('translate_languages')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.languages.localizations', $language->id) }}">
                        ...
                        @can('add_languages')
                            <form action="{{ route('vendor.languages.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!--language info start-->
...
@section('scripts')
    <script>
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('vendor.languages.updateStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    is_active: is_active
                },
        ...
        function handleDefaultLangSubmit(el) {
            $.post('{{ route('vendor.languages.defaultLanguage') }}', {
                    _token: '{{ csrf_token() }}',
