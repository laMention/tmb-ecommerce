    ...
    <div class="container-fluid">
        <nav class="navbar navbar-top navbar-expand" id="navbarDefault">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                @if (Route::is('vendor.pos.index'))
                    <div class="align-items-center d-none d-lg-flex">
                        <a class="pe-3" href="{{ route('vendor.dashboard') }}" data-bs-toggle="tooltip"
                ...
                <ul class="navbar-nav flex-row align-items-center tt-top-navbar">
                    ...
                    <li class="nav-item dropdown tt-curency-lang-dropdown d-none d-md-block">
                        <a href="javascript:void(0);" class="nav-link" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <img src="{{ asset('backend/assets/img/flags/' . $currentLanguage->flag . '.png') }}"
                            ...
                            @foreach (\App\Models\Language::where('is_active', 1)->get() as $key => $language)
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                        ...
                                        <img src="{{ asset('backend/assets/img/flags/' . $language->flag . '.png') }}"
                    ...
                    @php
                        ...
                        if (is_null($currentCurrency)) {
                            $currentCurrency = \App\Models\Currency::where('code', env('DEFAULT_CURRENCY_CODE'))->first();
                        }
                    @endphp
                            ...
                            <div class="card-body p-0">
                                <div class="scrollbar-overlay">
                                    ...
                                    @can('contact_us_messages')
                                        @if ($newMsgCount > 0)
                                            <div class="p-3 position-relative border-bottom">
                                                <a href="{{ route('vendor.queries.index') }}"
                                                    class="d-flex align-items-center">
                            ...
                            <div class="card position-relative border-0">
                                <div class="card-body py-2">
                                    <ul class="tt-user-nav list-unstyled d-flex flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link px-0" href="{{ route('vendor.profile') }}">
                                        ...
                                        @can('edit_shop')
                                            <li class="nav-item">
                                                <a class="nav-link px-0" href="{{ route('vendor.shops.edit') }}">
