...
<body>
    ...
    @if (!Route::is('vendor.pos.index'))
        ...
        @include('shop.vendor.inc.leftSidebar')
    ...
    <main class="tt-main-wrapper bg-secondary-subtle"
        ...
        @if (!Route::is('vendor.pos.index')) id="content" @else  id="pos-content" @endif>

        <!--header section start-->

        @include('shop.vendor.inc.navbar')
        ...
        @if (!Route::is('vendor.pos.index'))
            ...
            @include('shop.vendor.inc.footer')
