...
@section('title')
    {{ localize('Edit table') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
        ...
        <div class="container">
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Edit Table') }}</h2>
                            </div>
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    ...
                    <form action="{{ route('vendor.table.update') }}" method="POST" enctype="multipart/form-data" >
                        @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="num_table" id="num_table"
                                        placeholder="{{ localize('Numéro de la table') }}" class="form-control"
                                         required value="{{$table->num_table}}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="nombre_chaise" id="nombre_chaise"
                                        placeholder="{{ localize('Nombre de chaise') }}" class="form-control"  value="{{$table->nombre_chaise}}">
                                        <span class="fs-sm text-muted">
