...
@section('title')
    {{ localize('Edit Shop') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Edit Shop') }}</h2>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="shop_address" id="shop_address"
                                        placeholder="{{ localize('Shop address') }}" class="form-control" required value="{{$shop->shop_address}}">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="admin_commission_percentage" id="admin_commission_percentage"
                                        placeholder="{{ localize('Commission') }}" class="form-control" min="0" value="{{$shop->admin_commission_percentage}}">
                                </div>

                                <div class="mb-4">
                                    <label for="text" class="form-label">{{ localize('Shop url') }}</label>
                                    <input type="text" name="shop_address" id="shop_address"
                                        placeholder="{{ localize('Shop url') }}" class="form-control" value="{{$shop->slug}}">
                                </div>
                                    ...
                                    <div class="tt-image-drop rounded">
                                        ...
                                        <div class="tt-product-thumb show-selected-files mt-3">
                                            <div class="avatar avatar-xl cursor-pointer choose-media"
                                                ...
                                                <input type="hidden" name="image" value="{{ $shop->shop_logo }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="phone" id="phone"
                                        placeholder="{{ localize('Manager phone') }}" class="form-control" disabled value="{{$shop->user->phone}}">
                                </div>

                                <div class="mb-4">
                                    <label for="text" class="form-label">{{ localize('Manager email address') }}</label>
                                    <input type="text" name="email_address" id="email_address"
                                        placeholder="{{ localize('Email address') }}" class="form-control" disabled value="{{$shop->user->email}}">
                                </div>
