...
@section('title')
    {{ localize('Serveurs') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
          ...
          <div class="card mb-4" id="section-1">
            ...
            <table class="table tt-footable border-top" data-use-parent-width="true">
              <thead>
                <tr>
                    ...
                    <th class="text-center">{{ localize('Code serveur') }}</th>
                    <th>{{ localize('Name') }}</th>
            ...
            <div class="d-flex align-items-center justify-content-between px-4 pb-4">
              <span>{{ localize('Affichage') }}
                  ...
                  {{ $waiters->total() }} {{ localize('resultats') }}</span>
              <nav>
