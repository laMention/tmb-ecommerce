        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    ...
                    <form action="{{ route('vendor.waiters.store') }}" method="POST" enctype="multipart/form-data" >
                        @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="adresse" id="adresse"
                                        placeholder="{{ localize('Serveur address') }}" class="form-control" required>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="contact" id="contact"
                                        placeholder="{{ localize('contact') }}" class="form-control" >
                                </div>
