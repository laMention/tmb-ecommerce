        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-5 col-lg-6">
                ...
                <div class="gshop_subscribe_form text-center">
                    ...
                    <h4 class="text-white gshop-title">{{ localize('S Abonnez- pour des ') }}<mark

                            class="p-0 position-relative text-secondary bg-transparent"> {{ localize('Nouvelles Arrivées') }}
                            ...
                            class="d-none d-sm-block">{{ localize('Et d autres informations.') }}</h4>
                    ...
                    <form class="mt-5 d-flex align-items-center bg-white rounded subscribe_form"
                        ...
                        <input type="email" class="form-control" placeholder="{{ localize('Entrer l adresse e-mail') }}"
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                ...
                <div class="footer-widget">
                    ...
                    <ul class="footer-nav">
                        ...
                        <li><a href="{{ route('customers.profile') }}">{{ localize('Mettre a jour le profil') }}</a></li>
