<div class="footer-curve position-relative overflow-hidden">
    <span class="position-absolute section-curve-wrapper top-0 h-100"
        data-background="{{ asset('frontend/default/assets/img/shapes/section-curve.png') }}"></span>
</div>

<footer class="gshop-footer position-relative pt-8 bg-dark z-1 overflow-hidden">
    <img src="{{ asset('frontend/default/assets/img/shapes/tomato.svg') }}" alt="tomato"
        class="position-absolute z--1 tomato vector-shape">
    <img src="{{ asset('frontend/default/assets/img/shapes/pata-lg.svg') }}" alt="pata"
    ...
    <img src="{{ asset('frontend/default/assets/img/shapes/frame-circle.svg') }}" alt="frame"
    ...
    <!--shape right -->
    <img src="{{ asset('frontend/default/assets/img/shapes/leaf.svg') }}" alt="pata"
        class="position-absolute leaf-2 z--1 vector-shape">
    <img src="{{ asset('frontend/default/assets/img/shapes/pata-xs.svg') }}" alt="pata"
        class="position-absolute pata-xs-2 z--1 vector-shape">
    <img src="{{ asset('frontend/default/assets/img/shapes/tomato-slice.svg') }}" alt="tomato slice"
            ...
            <div class="col-xl-5 col-lg-6">
                <div class="gshop_subscribe_form text-center">
                    <h4 class="text-white gshop-title">{{ localize('Subscribe to the us') }}<mark
                            ...
                            <img src="{{ asset('frontend/default/assets/img/shapes/border-line.svg') }}"
