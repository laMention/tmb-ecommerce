<script src="{{ asset('frontend/default/assets/js/vendors/jquery-3.6.4.min.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/jquery-ui.min.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/swiper-bundle.min.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/simplebar.min.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/parallax-scroll.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/isotop.pkgd.min.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/countdown.min.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/range-slider.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/waypoints.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/counterup.min.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/vendors/clipboard.min.js') }}"></script>

<script src="{{ asset('frontend/common/js/toastr.min.js') }}"></script>
<script src="{{ asset('frontend/common/js/select2.js') }}"></script>
<script src="{{ asset('frontend/default/assets/js/app.js') }}"></script>
