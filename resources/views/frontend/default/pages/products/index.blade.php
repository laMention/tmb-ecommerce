...
@section('breadcrumb-contents')
    <div class="breadcrumb-content">
        <h2 class="mb-2 text-center">{{ localize('Des produits') }}</h2>
        <nav>
            <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item fw-bold" aria-current="page"><a
                        href="{{ route('home') }}">{{ localize('Acceuil') }}</a></li>
                    ...
                    <div class="col-xl-9">
                        <div class="shop-grid">
                            ...
                            <div
                                ...
                                <p class="mb-0 fw-bold">{{ localize('Montrant') }}
                                    {{ $products->firstItem() }}-{{ $products->lastItem() }} {{ localize('de') }}
                                    {{ $products->total() }} {{ localize('résultats') }}</p>
                                <div class="listing-top-right text-end d-inline-flex align-items-center gap-3 flex-wrap">
                                    <div class="number-count-filter d-flex align-items-center gap-3">
                                        <label
                                            class="fw-bold fs-xs text-dark flex-shrink-0">{{ localize('Montrer') }}:</label>
                                        <input type="number"
                                            @isset($per_page)
                                        value="{{ $per_page }}"
                                        @else
                                    ...
                                    <div class="select-filter d-inline-flex align-items-center gap-3">
                                        ...
                                        <select name="sort_by"
                                            ...
                                            <option value="new"
                                                ...
                                                @endif
                                            @endisset>
                                                {{ localize('Le plus récent d abord') }}</option>
                                            ...
                                            @endif
                                        @endisset>
                                                {{ localize('Meilleure vente') }}</option>
                                        </select>
                                    </div>
