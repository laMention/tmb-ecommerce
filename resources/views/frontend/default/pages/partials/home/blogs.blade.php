        ...
        <div class="row justify-content-center">
            <div class="col-xl-5">
                <div class="section-title text-center">
                    <h2 class="mb-3">{{ localize('Parcourir les messages récents') }}</h2>
                    <p class="mb-0">{{ localize('En savoir plus sur nos récentes actualités exclusives, Mises à jour et articles') }}
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <article class="blog-card rounded-2 overflow-hidden bg-white">
                        ...
                        <div class="blog-card-content">
                            ...
                            <a href="{{ route('home.blogs.show', $blog->slug) }}"
                                class="btn btn-primary-light btn-md">{{ localize('Explore plus') }}<span
