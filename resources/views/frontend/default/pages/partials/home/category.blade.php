    ...
    <div class="container">
        ...
        <div class="gshop-category-box border-secondary rounded-3 bg-white">
            ...
            <div class="text-center section-title">
                ...
                <h4 class="d-inline-block px-2 bg-white mb-4">{{ localize('Nos principales catégories') }}</h4>
                    ...
                    <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                        ...
                        <div
                            ...
                            <a href="{{ route('products.index') }}?&category_id={{ $category->id }}"
                                ...
                                class="text-dark fs-sm fw-bold d-block mt-3">{{ $category->collectLocalization('nom') }}</a>
