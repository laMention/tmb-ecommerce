<section class="ptb-120 bg-shade position-relative overflow-hidden z-1 feedback-section">
    <img src="{{ asset('frontend/default/assets/img/shapes/bg-shape-5.png') }}" alt="bg shape"
        class="position-absolute start-0 bottom-0 z--1 w-100">
    <img src="{{ asset('frontend/default/assets/img/shapes/map-bg.png') }}" alt="map"
        class="position-absolute start-50 top-50 translate-middle z--1">
    <img src="{{ asset('frontend/default/assets/img/shapes/fd-1.png') }}" alt="shape"
        class="position-absolute z--1 fd-1">
    <img src="{{ asset('frontend/default/assets/img/shapes/fd-2.png') }}" alt="shape"
        class="position-absolute z--1 fd-2">
    <img src="{{ asset('frontend/default/assets/img/shapes/fd-3.png') }}" alt="shape"
        class="position-absolute z--1 fd-3">
    <img src="{{ asset('frontend/default/assets/img/shapes/fd-4.png') }}" alt="shape"
        class="position-absolute z--1 fd-4">
    <img src="{{ asset('frontend/default/assets/img/shapes/fd-5.png') }}" alt="shape"
